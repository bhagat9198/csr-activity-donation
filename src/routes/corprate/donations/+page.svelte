		...
		<div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" 
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Donations</span>
            </a>
          </li>
				...
				<li class="w-full mt-4">
				    ...
				    <li class="mt-0.5 w-full">
              <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="/corprate/profile">
	...
	>
		...
		>
			<div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
				<nav>
					<h6 class="mb-2 ml-2 font-bold text-white capitalize">Donations</h6>
				</nav>
			</div>
		</nav>
			...
			>
				<div class="flex justify-between flex-wrap -mx-3 my-4">
					<div class="flex-none w-auto max-w-full px-3 my-auto">
						<div class="h-full">
							<h5 class="mb-1">Your All Donations</h5>
						</div>
					</div>
					<div class="pr-4">
					...
					<div class="flex-auto p-4">
						<div class="flex flex-wrap -mx-3">
							<div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
								...
								>
									<div on:click={() => displayAddModal.status = true} class="flex flex-col justify-center flex-auto p-6 text-center">
										<a href="javascript:;">
	...
	<div class="container flex gap-2 bg-white p-4 rounded-5">
		<div class="flex flex-wrap mx-10">
			<div class=" w-full flex justify-between mb-5">
				<h5 class="font-bold pt-3">Donation Name</h5>
				<div class="px-3">
					<div
			...
			<p class="mb-12">
				Donation descrption Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram
