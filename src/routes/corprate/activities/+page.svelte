...
>
	<aside
		class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 py-5 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent"
	>
		<div class="h-19.5">
			<i
		...
		<div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
			<ul class="flex flex-col pl-0 mb-0">
				<li class="mt-0.5 w-full">
					<a
						class="py-2.7 rounded-lg bg-white font-semibold text-slate-700 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
	...
	>
		...
		>
			<div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
				<nav>
					<h6 class="mb-2 ml-2 font-bold text-white capitalize">Activities</h6>
				</nav>
			</div>
		</nav>
		...
		<div class="w-full px-6 mx-auto">
			...
			>
				<li class="flex items-center px-4 text-green-400">
			...
			>
				<div class="flex justify-between flex-wrap -mx-3 my-4">
					<div class="flex-none w-auto max-w-full px-3 my-auto">
						<div class="h-full">
							<h5 class="mb-1">Your All Activities</h5>
						</div>
					</div>
					<div class="pr-4">
					...
					<div class="flex-auto p-4">
						<div class="flex flex-wrap -mx-3">
							<div class="w-full max-w-full px-3 mb-6 md:w-6/12 md:flex-none xl:mb-0 xl:w-3/12">
								...
								>
									<div class="flex flex-col justify-center flex-auto p-6 text-center cursor-pointer " on:click={() => displayAddModal.status = true} >
										<span>
								...
								>
									...
									<div class="flex-auto px-1 pt-6">
										...
										<div class="flex items-center justify-between">
											<button on:click={() => displayViewModal.status = true}
												type="button"
...
{#if displayAddModal.status}
	<div
		class="absolute top-0 left-0 w-full h-full opacity-80 bg-gray-500 m-0 p-0"
							...
							<form role="form text-left">
								...
								<div class="text-center">
									<button
										...
										>Add Activity</button
									>
									<button on:click={() => displayAddModal.status = false}
										type="button"
...
{#if displayViewModal.status}
	...
	>
		<div class="container flex gap-2 bg-white p-4 rounded-5">
			<div class="w-96">
				<iframe
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31085.583649101805!2d77.57846447285769!3d13.118311081466866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1856f737d2d5%3A0xbef78d20185d942f!2sYelahanka%2C%20Bengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1681627949740!5m2!1sen!2sin"
					width="300"
					height="225"
					style="border:0;"
					loading="lazy"
				...
				/>
				<h5 class="font-bold pt-3">Activity Name</h5>
				<p class="mb-12">
					Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram ipsum Loram
					ipsumLoram ipsum Loram ipsum Loram ipsum Loram ipsum
				</p>
			</div>
			<div>
				<div class="flex flex-wrap -mx-3">
					<div class="flex-none w-full max-w-full px-3">
						...
						>
							...
							<div class="px-3">
								...
								>
									<p on:click={() => displayViewModal.status = false} class="text-white px-3 pt-2">Close</p>
								</div>
							</div>
						</div>
