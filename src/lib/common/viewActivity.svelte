				...
				<div class="flex-none w-full max-w-full px-3">
					...
					>
						...
						<div class="px-3">
							...
							>
								<p on:click={() => updateViewModalState(false, {})} class="cursor-pointer text-white px-3 pt-2">
									Close
								</p>
							</div>
						</div>
								...
								>
									<div class="flex px-2 py-1">
										<div class="flex flex-col justify-center">
											...
											<p class="mb-0 leading-tight text-xs text-slate-400">{eachUserjoined.email}</p>
										</div>
									</div>
								</td>
							</tr>
